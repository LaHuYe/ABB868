	...
	; --fill=0xFFFF --output=intel app_adc.p1 app_charge.p1 app_key.p1 \
	; app_led.p1 app_process.p1 app_timer.p1 main.p1 app_motor.p1 \
	; app_water_process.p1 --chip=SC8P1712E -P --runtime=default, \
